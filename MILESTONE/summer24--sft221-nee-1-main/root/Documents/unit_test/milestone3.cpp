...
namespace BlackBoxTests
{
    ...
    public:
        ...
        {
            struct Truck vehicle = { 0, 1200, 0, 0, nullptr }; // 1200 is the max weight capacity
        ...
        {
            struct Truck vehicle = { 0, 1200, 0, 0, nullptr };
            struct DeliveryPackage pkg = { 1200, 1.0, {0, 0} }; // Exactly at capacity limit
            Assert::AreEqual(1, checkVehicleCapacity(vehicle, pkg));
        }
        ...
        {
            struct Truck vehicle = { 0, 1200, 0, 0, nullptr };
            struct DeliveryPackage pkg = { 1300, 1.0, {0, 0} }; // Over capacity
            Assert::AreEqual(0, checkVehicleCapacity(vehicle, pkg));
        }
