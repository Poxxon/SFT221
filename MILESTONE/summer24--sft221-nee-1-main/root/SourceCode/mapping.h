...
/**
 * retrieves name of truck line based on route symbol.
 *
 * @param routeSymbol truck route
 * @returns string representing name of truck line ('BLUE', 'GREEN', 'YELLOW')    
 */
const char* getTruckLine(char routeSymbol);

/**
 * determines closest point within a route to a specified point.
 *
 * @param route pointer to the route which contains a collection of points.
 * @param pt point to which the closest point in the route is to be found.
 * @returns index of the closest point within the route to specified point; returns -1 if  route is empty.
 */
